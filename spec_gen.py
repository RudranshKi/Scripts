...
spec_headers = ['Spec Name', 'Specs Description', 'Max Value', 'Typical Value', 'Min Value','unit']
...
corner_ref_data = corner_ref_data[0:len(corner_ref_data)-2]
corner_ref_data = list(np.transpose(corner_ref_data))
corner_ref_headers = ['Corner name','temperature']
...
plt.text(0.5, 0.95, "Table 1: Specification Data", {'fontname': 'Courier New', 'fontsize': 24, 'fontweight': 'bold'}, ha='center')
plt.text(0.01, 0.8, table_spec, {'fontname': 'Courier New', 'fontsize': 22 , 'fontweight': 'bold'})
plt.text(0.2, 0.75, "Table 2: Corner Data", {'fontname': 'Courier New', 'fontsize': 24, 'fontweight': 'bold'}, ha='center')
plt.text(0.01, 0.57, table_corner, {'fontname': 'Courier New', 'fontsize': 22 , 'fontweight': 'bold'})
plt.text(0.15, 0.5, "Table 3: Corner Reference", {'fontname': 'Courier New', 'fontsize': 24, 'fontweight': 'bold'}, ha='center')
plt.text(0.01, 0.32, table_corner_ref, {'fontname': 'Courier New', 'fontsize': 22 , 'fontweight': 'bold'})
plt.axis('off')
